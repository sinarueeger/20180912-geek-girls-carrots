...
`Question > Data > Analyse data with a tool > Distill information/data into knowledge > Feel enlightened :-) > Take decisions`
...
1. **Install** R :
  ...
  - Or (easier) use R in browser: [RStudio Cloud](https://rstudio.cloud/). (login with gmail account).
...
## `r icon::fa_users(colour = "black")` R community can help you help you learn! `r emo::ji("party")`
