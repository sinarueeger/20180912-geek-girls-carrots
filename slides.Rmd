...
1. **Install** R :
  ...
  - Or use R in browser: [RStudio Cloud](https://rstudio.cloud/). 
...
## `r icon::fa_users(colour = "black")` R community can help you help you learn!

---
class: left, middle

## R weekly Newsletter `r icon::fa_dove (colour = "black")` `r icon::fa_envelope (colour = "black")`

- Submit & subscribe here: https://rweekly.org/

- Weekly selection of blogposts delivered into your mailbox.
...
[Take part in TidyTuesday](https://github.com/rfordatascience/tidytuesday)!
